...
```javascript
  async user.index({
    name: 'Ducilio Mateus Manjate',
    age: 25,
    city: 'Foz do Iguaçu, Parana', 'Mozambique, Maputo'
    stack: ['ReactJs', 'PHP/Laravel', '(My|Postgre)SQL', 'C/Arduino'],
...
- 🎵 In love with music especially rap
- :DONE II my first album commit soon.
